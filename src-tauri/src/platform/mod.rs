...
///
/// This build ships the X11 backend only. On a Wayland session it
/// still works through XWayland, which is what Debian's own packages rely on.
